...
public class StopWatch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        minute.setFont(new java.awt.Font("Ubntu", 0, 48));
        minute.setText("00 :");

        second.setFont(new java.awt.Font("Ubntu", 0, 48));
        second.setText("00 :");

        milisecond.setFont(new java.awt.Font("Ubntu", 0, 36));
        milisecond.setText("00");

        hour.setFont(new java.awt.Font("Ubntu", 0, 48));
        hour.setText("00 :");
        ...
        jButton4.setFont(new java.awt.Font("JetBrains Mono", 3, 24)); // NOI18N
        ...
        jButton5.setFont(new java.awt.Font("JetBrains Mono", 3, 24)); // NOI18N
